...
void Shader::setFloat4f(const std::string& name, float value0, float value1, float value2, float value3) const
{
	glUniform4f(glGetUniformLocation(ID, name.c_str()), value0, value1, value2, value3);
}
void Shader::setMatrix4f(const std::string& name, glm::f32* matrix)
{
